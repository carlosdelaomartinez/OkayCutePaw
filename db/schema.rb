...
ActiveRecord::Schema.define(version: 2019_10_25_215237) do
  ...
  create_table "question_answers", force: :cascade do |t|
    ...
    t.index ["user_id", "question_id"], name: "index_question_answers_on_user_id_and_question_id", unique: true
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer "looking_age_lower", null: false
    t.integer "looking_age_higher", null: false
